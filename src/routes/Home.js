...
const health = [
  ...
  },
  {
    ...
    dscr:
      "이 책은 불면증, 만성피로, 두통, 냉증, 어깨결림, 변비 등 신체 증상부터 우울, 무기력, 자기혐오, 짜증, 의욕 상실, 예민, 충동 등 마음의 변화까지 일상생활에서 흔히 겪는 불편함의 원인과 그 대처법을 그림과 함께 알기 쉽고 간결하게 정리했다.",
  },
];
const economy = [
  {
...
const highschool = [
  ...
  },
  {
    ...
    dscr:
      "체계적인 구문 개념 학습을 원하는 학생을 위해 제작되었다. 총 1,001개 문장으로 구성되어 있으며, 수능에 나오는 모든 구문의 유형을 총 망라하여 수록되어 있다. 전 문장 끊어 읽기와 구문 분석을 제공하고 있기 때문에 혼자서도 기초를 체계적으로 학습할 수 있다. ",
  },
];
const classic = [
  {
...
const calendar = [
  {
    ...
    dscr:
      "밥 없이는 살아도, 빵 없이는 못 사는 전국의 빵순이들을 위해 준비한 '다운타운믹스주쓰' 빵일력. '일요일의 빵모임'을 열 정도로 빵에 애정이 가득한 주쓰 작가의 첫 번째 일력으로, 귀엽지만 어딘가 이상하면서 파괴적인 캐릭터들이 특징인 다믹주 세계관을 기반으로 한다.",
  },
  {
