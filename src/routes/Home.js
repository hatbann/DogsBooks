...
const cook = [
  {
    uri: "https://image.aladin.co.kr/product/30393/39/coversum/k582830065_1.jpg",
    id: 0,
    title: "사유 식탁 - 양장, 영혼의 허기를 달래는 알랭 드 보통의 132가지 레시피",
    author: "알랭 드 보통",
    dscr: "연애와 철학을 접목한 독특한 글쓰기로 ‘닥터 러브’라는 별칭까지 얻은 알랭 드 보통이 뜻밖…‘인생학교’를 통해 출간한 이 책에서 알랭 드 보통은 요리와 식사를 철학으로 사유한다.\n",
  },
  {
    uri: "https://image.aladin.co.kr/product/30328/13/coversum/k782839137_1.jpg",
    id: 1,
    title: "만 원으로 차리는 파인 다이닝 - 식비 걱정 NO! 요리용디 가성비 레시피",
    author: "요리용디",
    dscr: "87만 구독자가 인정한 푸드 크리에이터 요리용디의 ‘만 원으로 차리는 파인 다이닝’은 만 …쉽게 찾을 수 있는 재료로 파인 다이닝 레스토랑에서나 볼 법한 근사한 요리를 만들어낸다.",
  },
];
const health = [
  {
    uri: "https://image.aladin.co.kr/product/26952/44/coversum/k872730815_2.jpg",
    id: 0,
    title: "백년 허리 1 : 진단편 - 내 허리 통증 해석하기",
    author: "정선근",
    dscr: "서울대 의대 재활의학과 정선근 교수의 스테디셀러인 '백년허리'의 개정증보판이다. 백년허리의…을 뿐 아니라, 허리 통증은 진화의 축복이라는 요통에 대한 새로운 관점을 제시하고 있다.",
  },
  {
    uri: "https://image.aladin.co.kr/product/30083/38/coversum/k472839475_1.jpg",
    id: 1,
    title: "이게 다 호르몬 때문이야 - 내 몸과 마음이 달라지는 49가지 호르몬 법칙",
    author: "마쓰무라 게이코 (지은이), 이은혜 (옮긴이)",
    dscr: "불면증, 만성피로, 두통, 냉증, 어깨결림, 변비 등 신체 증상부터 우울, 무기력, 자기혐…활에서 흔히 겪는 불편함의 원인과 그 대처법을 그림과 함께 알기 쉽고 간결하게 정리했다.",
  },
];
const economy = [
  {
    uri: "https://image.aladin.co.kr/product/30169/22/coversum/8959897094_3.jpg",
    id: 0,
    title: "트렌드 코리아 2023 - 서울대 소비트렌드 분석센터의 2023 전망",
    author: "김난도, 전미영, 최지혜, 이수진, 권정윤, 이준영, 이향은, 한다혜, 이혜원, 추예린",
    dscr: "2년이 넘는 시간 동안 지속된 코로나19 사태를 거치면서 우리의 삶은 큰 변화를 맞이했다.…수는 없었다. 그렇다면 우리는 무엇을 무기로 삼아 변화로 가득한 세상을 헤쳐나갈 것인가?",
  },
  {
    uri: "https://image.aladin.co.kr/product/23616/25/coversum/k652638520_2.jpg",
    id: 1,
    title: "부자의 언어 - 어떻게 살아야 부자가 되는지 묻는 아들에게",
    author: "존 소포릭 (지은이), 이한이 (옮긴이)",
    dscr: "가난했던 한 아빠가 부자가 되기까지 지녔던 소신과 개념, 원칙을 솔직하고 다정한 목소리로 …은 인생에서 ‘경제적 자유’를 얻기 위해 노력한 한 아빠의 스펙터클한 여정이 담겨 있다.",
  },
];
const highschool = [
  {
    uri: "https://image.aladin.co.kr/product/27800/72/coversum/8928333369_1.jpg",
    id: 0,
    title: "신사고 쎈 고등 수학 (상) (2023년용)",
    author: "홍범준, 김의석, 김형정, 김형균, 김윤희, 신사고수학콘텐츠연구회 (지은이)",
    dscr: "전국 고등학교 내신 기출 문제와 평가원.수능 기출 문제는 물론 수많은 기본서, 내신서, 수…어 수준별로 구성하고, 유형 뽀개기에서는 이를 다시 하, 중, 상의 난이도로 세분하였다.",
  },
  {
    uri: "https://image.aladin.co.kr/product/28101/59/coversum/8968062285_1.jpg",
    id: 1,
    title: "천일문 기본 Basic 1001 Sentences - 2021년 최신개정판/고1 대상/천일비급 별책포함",
    author: "김기훈, 쎄듀 영어교육연구센터 (지은이)",
    dscr: "체계적인 구문 개념 학습을 원하는 학생을 위해 제작되었다. 총 1,001개 문장으로 구성되…어 읽기와 구문 분석을 제공하고 있기 때문에 혼자서도 기초를 체계적으로 학습할 수 있다.",
  },
];
const classic = [
  {
    ...
    dscr: "2차 세계대전 중 많은 독일 젊은이들이 전장에 나가면서 군복 주머니 속에 품고 갔던 책. …이들을 그렸다. 지금까지도 젊은이들에게 '통과의례'처럼 읽히고 있는 명작을 새로 옮겼다.",
  },
  {
    ...
    dscr: "자살 미수와 약물 중독, 39세의 젊은 나이에 자살로 생을 마감한 다자이 오사무의 작품 <…타임스는 '인간의 나약함을 드러내는 데 있어 다자이보다 뛰어난 작가는 드물다'고 평했다.",
  },
];
const science = [
  {
    uri: "https://image.aladin.co.kr/product/30275/28/coversum/k962839725_1.jpg",
    id: 0,
    title: "생물은 왜 죽는가",
    author: "고바야시 다케히코",
    dscr: "노화는 죽음을 향해 다가가고 있다는 신호로서 우리에게 죽음에 대한 공포를 불러일으킨다. 도…인 저자가 우리에게 절대 공포로 남아 있는 ‘죽음’의 의미를 생물학의 관점에서 풀어낸다.",
  },
  {
    ...
    dscr: "<콘택트>, <창백한 푸른 점> 등의 지은이 칼 세이건의 저작 중에서 가장 유명한 이 책은…어, 출간 20년이 훌쩍 넘은 지금도 가장 읽을만한 교양서 중 하나로 자리매김하고 있다.",
  },
];
const calendar = [
  {
    uri: "https://image.aladin.co.kr/product/30382/27/coversum/8925577364_1.jpg",
    id: 0,
    title: "2023 오늘도 빵먹일력 (스프링)",
    author: "주쓰",
    dscr: "밥 없이는 살아도, 빵 없이는 못 사는 전국의 빵순이들을 위해 준비한 '다운타운믹스주쓰' …, 귀엽지만 어딘가 이상하면서 파괴적인 캐릭터들이 특징인 다믹주 세계관을 기반으로 한다.",
  },
  {
    ...
    title: "2023 인생일력",
    author: "민음사 편집부 (지은이)",
    dscr: "2018년부터 많은 사랑을 받아온 민음사 인생일력이 올해에도 찾아왔다. 민음사의 동양고전 …에 편지를 쓰거나, 그날그날 마음을 적어 보자. 당신의 하루가 소중한 기록이 될 것이다.",
  },
];
const university = [
  {
    uri: "https://image.aladin.co.kr/product/19338/44/coversum/k892635608_1.jpg",
    id: 0,
    title: "이기적 유전자, 반격의 사피엔스 - 진화생물학에서 찾은 행복의 기원",
    author: "권행백 (지은이)",
    dscr: "나의 개성과 존재의 근원은 무엇인가?”라는 물음에서 출발하는 인문서이며,  ‘자기답게 살기’의 노하우를 진화생물학에서 구하는 행복론이다.",
  },
  {
    ...
    dscr: "군중의 심리를 일찍이 간파한 이들은 손쉽게 군중의 지배자가 될 수 있다. 세계의 모든 지배… 어리석고 우매한 군중의 심리를 본능적으로 확실하게 알고 있는 무의식적 심리학자들이었다.",
  },
];
const comic = [
  {
    uri: "https://image.aladin.co.kr/product/30342/47/coversum/k382839443_1.jpg",
    id: 0,
    title: "주술회전 20",
    author: "아쿠타미 게게 (지은이), 이정운 (옮긴이)",
    dscr: "서로의 술식으로 인해 압사 직전에 놓인 후시구로와 레지. 대치 상황을 타파하기 위해 레지가… 무너뜨리고, 과거 주술사와 특급 주령을 끼워 넣은 치열하기 그지없는 싸움을 펼치는데?!",
  },
  {
    uri: "https://image.aladin.co.kr/product/30154/21/coversum/k302839487_1.jpg",
    id: 1,
    title: "체인소 맨 : 버디 스토리즈",
    author: "히시카와 사카쿠 (지은이), 후지모토 타츠키 (원작)",
    dscr: "방약무인한 자칭 명탐정 파워와 조수 신세가 된 덴지. 콤비 결성 후 9년 차, 공안에서의 …버디를 주제로 한 세 가지 이야기에, 보너스 트랙으로 꿈의 에노시마 스토리까지 수록했다.",
  },
];
const socialScience = [
  {
    ...
    author: "이라영",
    dscr: "한국 사회의 뜨거운 논제들을 치밀하고 날카롭게 다뤄오며, 시대를 통찰하는 저서를 집필해온 예술사회학자 이라영의 2년 만의 단독 저서이다.",
  },
  {
    uri: "https://image.aladin.co.kr/product/30313/93/coversum/k212839130_1.jpg",
    id: 1,
    title: "제국의 충돌 - ‘차이메리카’에서 ‘신냉전’으로",
    author: "훙호펑 (지은이), 하남석 (옮긴이)",
    dscr: "미국과 중국 기업들 사이의 변화가 두 나라의 정치적 관계 변화의 기저에 있다는 것을 논증한…관계 악화를 민주주의 체제-권위주의 체제의 대립으로 설명하는 것과는 차별화되는 지점이다.",
  },
];
const novel = [
  {
    uri: "https://image.aladin.co.kr/product/27692/63/coversum/s772839857_2.jpg",
    id: 0,
    title: "지구 끝의 온실",
    author: "김초엽",
    dscr: "김초엽 첫 장편소설. 『우리가 빛의 속도로 갈 수 없다면』을 통해 이미 폭넓은 독자층을 형…을 받고 있는 김초엽 작가는 더스트로 멸망한 이후의 세계를 첫 장편소설의 무대로 삼았다.",
  },
  {
    ...
    dscr: "역사의 상처에서 태어나 단 한 번도 존재의 가벼움을 느껴 보지 못한 현대인, 그들의 삶과 … 약한 테레자, 사비나의 외로운 삶. 토마시에게 테레자는 무거움이요 사비나는 가벼움이다.",
  },
];
/*
const test=[
...
const essay = [
  {
    uri: "https://image.aladin.co.kr/product/30328/61/coversum/k362839230_1.jpg",
    id: 0,
    title: "인생의 역사 - '공무도하가'에서 '사랑의 발명'까지",
    author: "신형철 ",
    dscr: "우리 문학을 향한 '정확한 사랑'이자 시대를 읽는 탁월한 문장, 평론가 신형철이 4년 만의…를 읽고 시를 나누는 이야기, 그리하여 시에서 인생을 배우고 인생을 시로 이루는 글이다.",
  },
  {
    uri: "https://image.aladin.co.kr/product/28388/33/coversum/k732835819_1.jpg",
    id: 1,
    title: "땅콩일기 - 쩡찌 그림 에세이",
    author: "쩡찌",
    dscr: "작가 쩡찌가 ‘땅콩’을 통해 일상에서 겪는 마음의 일들을 진솔하게 담아낸 그림일기. 201…롭게 편집해 선보이는 소장판이다. 이에 더해 추가컷, 미공개 에피소드 등을 다수 담았다.",
  },
];
/*
const travel=[
...
const history = [
  {
    uri: "https://image.aladin.co.kr/product/30354/12/coversum/8936479202_1.jpg",
    id: 0,
    title: "[세트] 나의 문화유산답사기 11~12 서울편 세트 - 전2권",
    author: "유홍준",
    dscr: "도서 '나의 문화유산답사기 서울편 11'과 '나의 문화유산답사기 서울편 12' 세트 상품이다.",
  },
  {
    ...
    dscr: "재레드 다이아몬드, 대니얼 카너먼, 마크 저커버그가 격찬한 베스트셀러. 멀고먼 인류의 시원…거쳐 끊임없이 진화해온 인간의 역사를 다양하고 생생한 시각으로 조명한 전인미답의 문제작.",
  },
];
const art = [
  {
    uri: "https://image.aladin.co.kr/product/30119/96/coversum/s592839818_1.jpg",
    id: 0,
    title: "미술관을 빌려드립니다 : 프랑스 편 - 당신을 위한 특별한 초대",
    author: "이창용",
    dscr: "루브르 박물관을 비롯해 오르세, 오랑주리, 로댕 미술관 등 프랑스를 대표하는 미술관을 돌아…를 거쳐 인상주의까지 서양 미술사조의 주요 흐름을 꿰뚫는 걸작들을 만나는 미술 기행서다.",
  },
  {
    ...
    author: "정우철",
    dscr: "손안에서 펼쳐지는 한국의 미술관들을 도슨트 정우철과 함께 읽는 시간. 환기미술관, 장욱진미…관 7곳을 엄선해 ‘미술관의 피리 부는 남자’, ‘미술관의 아이돌’ 정우철이 도슨트한다.",
  },
];
/*
const language=[
...
const humanities = [
  {
    uri: "https://image.aladin.co.kr/product/30382/55/coversum/k272830862_1.jpg",
    id: 0,
    title: "인생의 허무를 어떻게 할 것인가",
    author: "김영민",
    dscr: "사상사 연구자이자 칼럼니스트인 김영민 서울대 교수가 들려주는 인생의 허무와 더불어 사는 법…인 ‘허무’에 대한 오래된 사유의 결과물을 그만의 독특한 시선으로 포착해내고 재해석했다.",
  },
  {
    ...
    dscr: "왜 어떤 민족들은 다른 민족들의 정복과 지배의 대상으로 전락하고 말았는가. 왜 원주민들은 …가. “인간 사회의 다양한 문명은 어디서 비롯되는가?”라는 의문을 명쾌하게 분석한 명저.",
  },
];
/*
const selfDevelope=[
...
const computer = [
  {
    uri: "https://image.aladin.co.kr/product/25155/25/coversum/k282633473_1.jpg",
    id: 0,
    title: "모던 자바스크립트 Deep Dive - 자바스크립트의 기본 개념과 동작 원리",
    author: "이웅모",
    dscr: "자바스크립트를 둘러싼 기본 개념을 정확하고 구체적으로 설명하고, 자바스크립트 코드의 동작 …코드가 컴퓨터 내부에서 어떻게 동작할 것인지 예측하고, 명확히 설명할 수 있도록 돕는다.",
  },
  {
    uri: "https://image.aladin.co.kr/product/28819/83/coversum/k152836497_2.jpg",
    id: 1,
    title:
      "진짜 쓰는 실무 엑셀 - 유튜브 대표 엑셀 채널, 오빠두가 알려 주는 엑셀 함수, 보고서 작성, 데이터 분석 노하우!",
    author: "오빠두(전진권)",
    dscr: "대기업 직장 생활 10년의 실무 노하우와 엑셀 유튜브 채널을 운영하면서 들은 수많은 직장인…는 실무 엑셀' 한 권이면 빠른 일 처리로 워라밸을 실현하고, 일잘러로 거듭날 수 있다!",
  },
];
/*
const minor=[
...
const todays = [
  ...
  },
  {
    ...
    content: "흔들리고 떠밀리고 넘어져도 나는, 당신은, 우리는 결국 해낼 것이라는 믿음의 문장들",
    id: 1,
  },
  {
    uri: "http://image.kyobobook.co.kr/images/book/large/204/l9791165345204.jpg",
    title: "책들의 부엌",
    content: "갓 지은 맛있는 책 냄새가 폴폴 풍기는 여기는 ‘소양리 북스 키친’입니다",
    id: 2,
  },
  {
...
const Home = ({ userObj }) => {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      ...
      setImgNum(location.state); //레벨 버튼 눌러서 state값 넘겨줌.
    ...
    <div className={styles.container}>
      ...
      <div className={styles.profile}>
        ...
        {mainimg.map((item) => {
          return (
            <div key={item.id}>
              {item.id === imgNum ? <img className={styles.profile_img} src={item.imgSrc} /> : null}
            </div>
          );
        })}
